...
## Problem Statement
My Compnay had several customer complaints issues and wanted to develop a clustering model to categorize their different customer complaints groups to get an indication of how to handle each group.
